...
export default function MyGarden({
  ...
  const filteredBooks = books.filter((book) => {
    ...
    const phaseMatch =
      activePhases.length === 0 || activePhases.includes(book.phase);
    const seasonMatch =
      activeSeasons.length === 0 || activeSeasons.includes(book.season);
                ...
                <div className={styles.cardContent}>
                  ...
                  <div className={styles.divider}></div> */}
                    ...
                    <p className={styles.dateLabel}>
                      {(dict.phaseOfLive.items as any)[book.phase] ||
                        book.phase}
                    </p>
                  </div>
                </div>
