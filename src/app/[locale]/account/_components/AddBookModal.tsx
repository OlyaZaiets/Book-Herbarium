            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.selectGroup}>
                <select name="season" required>
                  ...
                  {Object.entries(dict.seasons?.items || {}).map(
                    ([key, value]) => (
                ...
                <select name="phase" required>
                  ...
                  {Object.entries(dict.phaseOfLive?.items || {}).map(
                    ([key, value]) => (
                      <option key={key} value={key}>
                        {value as string}
                      </option>
              ...
              <div className={styles.flowerSelectionArea}>
                <p className={styles.selectionLabel}>
                  Select a flower for your herbarium:
                </p>
                <div className={styles.flowerGrid}>
                  {flowerCatalog.map((flower: any) => (
                    <label key={flower.slug} className={styles.flowerLabel}>
                      ...
                      />
                      <div
                        className={`${styles.flowerCard} ${selectedFlower === flower.slug ? styles.selectedFlower : ''}`}
                      >
                        <Image
                        ...
                        />
                        <span>
                          {locale === 'uk' ? flower.name_uk : flower.name_en}
                        </span>
                      </div>
                    </label>
                  ))}
